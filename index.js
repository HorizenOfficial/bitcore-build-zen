...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-zen/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-zen -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-zen -o bitcore-lib-zen.js';
    }
